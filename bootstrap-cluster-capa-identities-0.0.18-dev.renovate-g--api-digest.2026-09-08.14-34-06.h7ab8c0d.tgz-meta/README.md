...
4. Set the repository secrets:
   ...
   | `MCTL_APP_PRIVATE_KEY` | Private key of the `giantswarm-mctlbot` GitHub App — mints a short-lived installation token for cross-repo write access (CMC, CCR, installations, teleport-fleet) |
