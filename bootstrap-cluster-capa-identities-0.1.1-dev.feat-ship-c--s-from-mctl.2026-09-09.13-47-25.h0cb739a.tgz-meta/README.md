...
missing or differ from the ones shipped with your `mctl` build are committed, and
if the default branch is protected they go through a pull request whose URL is
printed. The template's other files are copied only at creation.
